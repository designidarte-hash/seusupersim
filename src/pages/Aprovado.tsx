    ...
    <div className="min-h-screen flex flex-col bg-sunburst text-primary-foreground">
      ...
      <section className="py-16 px-4 text-center bg-background">
        <div className="max-w-md mx-auto space-y-6">
          ...
          <button
            onClick={() => navigate("/cadastro", { cpfData })}
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {benefits.map((b, idx) => (
              <div key={idx} className="space-y-3">
                ...
                <h3 className="text-2xl font-bold text-primary-foreground">{b.title}</h3>
                <p className="text-base md:text-lg text-primary-foreground/80 leading-relaxed">{b.description}</p>
              </div>
            ))}
        </div>
      </section>
      ...
      <section className="py-12 px-4 border-t border-primary-foreground/10">
        <div className="max-w-lg mx-auto text-center space-y-4">
          <h2 className="text-3xl font-bold text-primary-foreground">Dinheiro urgente, até para negativado</h2>
