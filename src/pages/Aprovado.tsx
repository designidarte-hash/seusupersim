    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="bg-background py-12 px-4">
        <div className="max-w-lg mx-auto text-center space-y-4">
          ...
          <Button
            onClick={() => navigate("/")}
            className="mt-4 px-10 h-14 text-base font-bold rounded-full bg-gradient-to-r from-[hsl(30,95%,55%)] to-[hsl(350,80%,60%)] text-white hover:opacity-90 shadow-lg transition active:scale-[0.98]"
          >
